...
- Location: tests/e2e/gameplay-smoke.spec.ts:215:1
...
- main:
  ...
  - text: Room J47YQ Turn Waiting Lobby
  - paragraph:
    - img "Current scene"
    - text: Waiting for players.
  - paragraph: http://127.0.0.1:4181/Karachi-Coup/#/lobby?room=J47YQ
  - button "Quick rules"
  - button "Start game"
  - button "Reset room"
  - paragraph: Players
  ...
  - list:
    - listitem:
      - strong: Host One
      - text: J47YQ-ae13d5d6 0 Rupees 0 Connections Connected Alive
  - button "Leave room"
  - text: host
```
