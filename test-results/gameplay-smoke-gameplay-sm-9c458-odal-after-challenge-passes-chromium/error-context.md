...
- Name: gameplay-smoke.spec.ts >> gameplay smoke >> gameplay: Zardaar Jugaad opens return modal after challenge passes
- Location: tests/e2e/gameplay-smoke.spec.ts:187:1
...
- main:
  ...
  - text: Room MFNY2 Turn Waiting Lobby
  - paragraph:
    - img "Current scene"
    - text: Waiting for players.
  - paragraph: http://127.0.0.1:4181/Karachi-Coup/#/lobby?room=MFNY2
  - button "Quick rules"
  - button "Start game"
  - button "Reset room"
  - paragraph: Players
  ...
  - list:
    - listitem:
      - strong: Host One
      - text: MFNY2-3011ebf2 0 Rupees 0 Connections Connected Alive
  - button "Leave room"
  - text: host
```
