...
- Name: home.spec.ts >> Karachi Coup shell >> peer room: host creates room and shows room code
- Location: tests/e2e/home.spec.ts:14:3
...
Call log:
  ...
  - waiting for getByTestId('room-link')
...
- main:
  ...
  - text: ready Lobby · Lobby host:open
  - navigation:
    - button "Home"
    - button "Host room"
    - button "Join room"
  ...
  - text: Room Y5XB4 Turn Waiting Lobby
  - paragraph:
    - text: "Scene:"
    - strong: Lobby
  - paragraph:
    - text: "Room link:"
    - strong: https://abhidya.github.io/Karachi-Coup/#/lobby?room=Y5XB4
  - button "Start game"
  - button "Rebuild lobby"
  - paragraph: Players
